...
class TestAmenity(unittest.TestCase):
    ...
    def test_save(self):
        ...
        self.assertNotEqual(self.amenity_instance.id,
                            self.another_amenity_instance.id)
        self.assertNotEqual(self.amenity_instance.created_at,
                            self.another_amenity_instance.created_at)
        self.assertNotEqual(self.amenity_instance.updated_at,
                            self.another_amenity_instance.updated_at)
        self.assertNotEqual(self.amenity_instance.__dict__,
                            self.another_amenity_instance.__dict__)
